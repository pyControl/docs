...
pyControl sessions generate a `.tsv` (tab separated value) file, whose name is determined by the subject ID, start date and time, e.g. *m1-2023-10-30-214942.tsv*
