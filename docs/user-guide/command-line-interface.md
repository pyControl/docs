...
You will be presented with a menu of the tasks currently in the folder *pyControl/tasks*.  Select the task 'blinker', the task will be uploaded to the board.  Hit enter to run the task, the blue LED on the board will blink on and off and you will see the state entries and timestamps printed to the screen.
